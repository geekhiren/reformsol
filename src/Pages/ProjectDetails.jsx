...
function BlogDetails({ projectsList, blogsList, tagList, servicesList, }) {
    ...
    useEffect(() => {
        if (projectsList?.length > 0) {
            setProjectDetais(projectsList.find(project => project.slug.toLowerCase() == projectSlug.projectSlug.toLowerCase()))
        }
    }, [projectsList])
